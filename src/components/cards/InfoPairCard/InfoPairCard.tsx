...
import { InfoPairCardSkeleton } from '@/src/components/cards/InfoPairCard/InfoPairCardSkeleton';
...
export const InfoPairCard: React.FC<InfoPairCardProps> = ({ 
  title, 
  titleIcon, 
  leftItem, 
  rightItem, 
  ...
  const content = isLoading ? (
    <InfoPairCardSkeleton showTitle={!!title} />
  ) : (
    <>
      {/* Header opcional */}
      {title && (
